...
public class DateFacts_parser implements File_parser {
	
	
	static int wasBornOnDateNum = 0;
	static int diedOnDateNum = 0;
	static int happenedOnDateNum = 0;
	static int wasCreatedOnDateNum = 0;
	static int wasDestroyedOnDateNum = 0;
