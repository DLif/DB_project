...
public class LiteralFacts_parser implements File_parser {
	
	static int hasNumberOfPeopleNum = 0;
	static int hasMottoNum = 0;
	
	static String hasNumberOfPeople_property = "<hasNumberOfPeople>";
	static String hasMotto_property ="<hasMotto>";
