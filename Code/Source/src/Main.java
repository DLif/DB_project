...
public class Main {
	...
	private static String loadConfig()
	{
		...
		try (InputStream input = new FileInputStream("config.properties"))
		{
			...
			int THREAD_POOL_SIZE = Integer.parseInt(prop.getProperty("threadPoolSize"));
			
			// configure thread pool
			ThreadPool.init(THREAD_POOL_SIZE);
			...
			DBBuilder.DESERIALIZE = false;
			DBBuilder.SERIALIZE   = false;
			DBBuilder.UPLOAD      = true;
